...
Installation:
unzip the downloaded file and make a folder in your webserver root directory. name it "radio". The index file is a simple html file that loads the player in an iframe and shows the name and duration of the file being played and the next one. 
You first need to add a folder to your radio folder and name it "files" and then execute generatelist.php in your browser to generate list.txt file to be used as the time table for your radio. 
